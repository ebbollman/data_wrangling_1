...
Can also look at `?read_excel` for help. Especially focus on sheet =
null or range = null if want to read-in specific cells.
...
Printed difference makes read\_csv better. Also, how characters get
parsed and incomplete variables handling etc.
